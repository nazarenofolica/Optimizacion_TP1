...
Comparando 6.2 con 6.3, el \textbf{ranking de las marcas cambia según qué
margen se use}: con margen neto, Don Carlo (0,82) es la peor inversión
...
Tres lecturas se desprenden de esta última tabla sin resolver todavía nada:
...
\begin{itemize}
  ...
  resultados.
  \item \textbf{matplotlib}: los seis gráficos del informe.
\end{itemize}
...
En criollo: con estos números, la decisión de soltar o no la paridad no es
...
\begin{enumerate}
  ...
  están dejando las dos cosas arriba de la mesa.
...
reglas. Y aun así conviene bajar la expectativa: incluso liberando ambas
restricciones a la vez, todo el margen de negociación disponible cabe en poco
más de tres puntos de participación de mercado.
...
resto del presupuesto libre. R4 solo empieza a morder, y a arrastrar plata
